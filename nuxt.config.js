...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', property: 'og:url', content: 'https://padi-open-water.netlify.app/' },
      { hid: 'og:site_name', property: 'og:site_name', content: 'PADI オープンウォーター試験対策クイズ' },
      { hid: 'og:description', property: 'og:description', content: 'PADIオープンウォーター試験対策のクイズです' }
    ],
    link: [
